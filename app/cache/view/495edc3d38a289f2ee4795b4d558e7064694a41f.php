...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(assets); ?>/admin/img/favicon.html">
    ...
    <link href="http://localhost/sinama/app/view/assets/admin/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css">
    <link href="http://localhost/sinama/app/view/assets/admin/css/owl.carousel.css" rel="stylesheet" type="text/css">
...
<link rel="stylesheet" type="text/css" href="<?php echo e(assets); ?>/ticket.css">
...
<link href="http://localhost/sinama/app/view/assets/jquery-datepicker/styles/jquery-ui-1.8.14.css" rel="stylesheet" type="text/css">
<script src="http://localhost/sinama/app/view/assets/jquery-datepicker/scripts/jquery-1.6.2.min.js"></script>
<script src="http://localhost/sinama/app/view/assets/jquery-datepicker/scripts/jquery.ui.datepicker-cc.all.min.js"></script>
...
<script src="http://localhost/sinama/app/view/assets/admin/tinymce/tinymce.min.js"></script>
...
<script src="http://localhost/sinama/app/view/assets/admin/js/bootstrap.min.js"></script>
<script src="http://localhost/sinama/app/view/assets/admin/js/jquery.scrollTo.min.js"></script>
<script src="http://localhost/sinama/app/view/assets/admin/js/jquery.nicescroll.js"></script>
<script src="http://localhost/sinama/app/view/assets/admin/js/jquery.sparkline.js"></script>
<script src="http://localhost/sinama/app/view/assets/admin/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
<script src="http://localhost/sinama/app/view/assets/admin/js/owl.carousel.js"></script>
<script src="http://localhost/sinama/app/view/assets/admin/js/jquery.customSelect.min.js"></script>

<script src="http://localhost/sinama/app/view/assets/admin/js/common-scripts.js"></script>

<script src="http://localhost/sinama/app/view/assets/admin/js/sparkline-chart.js"></script>
<script src="http://localhost/sinama/app/view/assets/admin/js/easy-pie-chart.js"></script>
